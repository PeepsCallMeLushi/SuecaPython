...
class Gui(Ui_Dialog):
    ...
    def gameMechs(self, a):
        while a != 0:
            ...
            if playerID == 1:
                ...
                print("|------------------------|")
                print("  O jogador tem o id: ", playerID)
                print("  O contador esta no: ", self.counter)
                print("|------------------------|")
                self.botDecisionMaking()
            if self.counter == 4:
                print("Cartas disponiveis: ",self.availCards)
                self.roundEnd()
                print("Cartas disponiveis: ",self.availCards)
    ...
    def botDecisionMaking(self):
        ...
        print("playhouse is: " + self.playHouse)
        print("powerhouse is: " + self.powerHouse)
        if self.counter == 0:
    ...
    def ai3Management(self, a, b):
        self.play_ai3.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + a.hand[b].getFigure() + a.hand[
                b].getHouse() + ".png');}")
    ...
    def loadVisuals(self):
        ...
        self.wwcd.setStyleSheet(
            "background-image:url('resources/backgrounds/wwcdbg.png'); background-color: transparent; background-repeat:no-repeat;")
        self.lldl.setStyleSheet(
            "background-image:url('resources/backgrounds/lldlbg.png'); background-color: transparent; background-repeat:no-repeat;")
        ...
        self.powerHouseIcon.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + self.powerHouse + ".png');}")
    ...
    def loadPlayerVisuals(self):
        ...
        self.pl_bt_01.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[0].getFigure() + human.hand[
                0].getHouse() + ".png');}")
        self.pl_bt_02.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[1].getFigure() + human.hand[
                1].getHouse() + ".png');}")
        self.pl_bt_03.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[2].getFigure() + human.hand[
                2].getHouse() + ".png');}")
        self.pl_bt_04.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[3].getFigure() + human.hand[
                3].getHouse() + ".png');}")
        self.pl_bt_05.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[4].getFigure() + human.hand[
                4].getHouse() + ".png');}")
        self.pl_bt_06.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[5].getFigure() + human.hand[
                5].getHouse() + ".png');}")
        self.pl_bt_07.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[6].getFigure() + human.hand[
                6].getHouse() + ".png');}")
        self.pl_bt_08.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[7].getFigure() + human.hand[
                7].getHouse() + ".png');}")
        self.pl_bt_09.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[8].getFigure() + human.hand[
                8].getHouse() + ".png');}")
        self.pl_bt_10.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[9].getFigure() + human.hand[
                9].getHouse() + ".png');}")
    ...
    def playerChoice(self):
        ...
        self.play_pl.setStyleSheet(
            "QPushButton{background-image:url('resources/cards/" + human.hand[self.clicked].getFigure() + human.hand[
